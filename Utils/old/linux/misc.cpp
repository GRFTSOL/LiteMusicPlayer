...
HBITMAP loadBmpFile(cstr_t szFile)
{
    ...
    BITMAPINFO        *lpbi = nullptr;                //BITMAPINFO (include infoheader and RGBQUAD)
    BITMAPINFOHEADER    *lpbih = nullptr;
    HANDLE                hFile;
    ...
    lpbi = (BITMAPINFO *) new uint8_t[sizeof(BITMAPINFOHEADER) + sizeof(RGBQUAD) * 256];
