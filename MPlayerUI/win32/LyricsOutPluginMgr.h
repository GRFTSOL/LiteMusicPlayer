...
#ifndef MPlayerUI_win32_LyricsOutPluginMgr_h
#define MPlayerUI_win32_LyricsOutPluginMgr_h

#include "LyricsOutPlugin.h"


class CLyricsOutPluginMgr : public IMLyrOutHost, public IEventHandler {
public:
    struct Plugins {
...
#endif // !defined(MPlayerUI_win32_LyricsOutPluginMgr_h)
