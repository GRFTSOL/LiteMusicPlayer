// HttpProtocol.cpp: implementation of the CHttpProtocol class.
//
//////////////////////////////////////////////////////////////////////
...
//    DBG_LOGDUMPS((char *)pData, nLen);
    return m_pNetFile->write((const char *)pData, nLen, nullptr);
}
...
#define IF_PROCESS_STR_FIELD(name, szValue, rpProperty)                        \
    ...
    while (1)
    {
        ...
        //         else if (strncmp(szPos, SZ_HH_CONTENT_RANGE, 15) == 0)
        //         {
        //             szPos += 15;
        //             // strncpy_safe(m_szConnection, CountOf(m_szContentRange), szPos, size_t(szEnd - szPos));
        //             ERR_LOG0("Content-Range: Not parsed");
        //             // m_dwAvailProp |= ;
        //         }
        else
        {
