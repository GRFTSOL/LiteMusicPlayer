...
__inline void idctRowCondDC (DCTELEM * row)
{
...
__inline void idctSparseColPut (uint8_t *dest, int line_size, 
                                     DCTELEM * col)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
...
__inline void idctSparseColAdd (uint8_t *dest, int line_size, 
                                     DCTELEM * col)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
        uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
__inline void idctSparseCol (DCTELEM * col)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
...
__inline void idct4col(uint8_t *dest, int line_size, const DCTELEM *col)
{
...
#define C3 C_FIX(0.5)
#define C_SHIFT (4+1+12)
__inline void idct4col_add(uint8_t *dest, int line_size, const DCTELEM *col)
{
    int c0, c1, c2, c3, a0, a1, a2, a3;
    const uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
#define R3 R_FIX(0.5)
#define R_SHIFT 11
__inline void idct4row(DCTELEM *row)
{
    int c0, c1, c2, c3, a0, a1, a2, a3;
    //const uint8_t *cm = cropTbl + MAX_NEG_CROP;
